define (require) ->
  ...
  DocumentsHeader = require('genghis/views/documents_header')
  Pagination      = require('genghis/views/pagination')
  DocumentView    = require('genghis/views/document')
  NewDocument     = require('genghis/views/new_document')
  NewGridFile     = require('genghis/views/new_grid_file')

  template        = require('hgn!genghis/templates/documents')

  FILE_API_MSG    = '<h2>Unable to upload file.</h2> Your browser does not support the File API. Please use a modern browser.'
