define (require) ->
  ...
  NavSection = require('genghis/views/nav_section')
  ...
  class Nav extends View
    ...
    navigateUp: (e) =>
      ...
      app.router.redirectTo(
        @model.has('database')   and @model.get('server'),
        @model.has('collection') and @model.get('database'),
        (@model.has('document') or @model.has('query')) and @model.get('collection')
      )
