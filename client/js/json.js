...
var GenghisJSON = {
    parse: function(src) {
        ...
        function replaceCallExpression(src) {
            ...
            function ISODate(date) {
                ...
                return {
                    '$genghisType': 'ISODate',
                    '$value': date ? new ISODateString(date) : null
                };
            }
    ...
    stringify: function(value, pretty) {
        return $('<div>' + this.prettyPrint(value, pretty, false) + '</div>').text();
    },
    ...
    prettyPrint: function (value, pretty, autoCollapse) {
        ...
        function jsonView(value) {
            ...
            var regexIdentifier = new RegExp('^[' + identifierStart + '][' + identifierStart + identifierPartExclusive + ']*$');
